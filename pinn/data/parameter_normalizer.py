...
class ParameterNormalizer:
    ...
    def normalize_pitch(pitch: np.ndarray) -> np.ndarray:
        ...
        Example:
            ...
            >>> # [0.0, 0.5, 1.0]
        """
        return (pitch - ParameterNormalizer.PITCH_MIN) / (ParameterNormalizer.PITCH_MAX - ParameterNormalizer.PITCH_MIN)
    ...
    def normalize_depth(depth: np.ndarray) -> np.ndarray:
        ...
        Example:
            ...
            >>> # [0.0, 0.5, 1.0]
        """
        return (depth - ParameterNormalizer.DEPTH_MIN) / (ParameterNormalizer.DEPTH_MAX - ParameterNormalizer.DEPTH_MIN)
    ...
    def denormalize_pitch(pitch_norm: np.ndarray) -> np.ndarray:
        ...
        """
        return pitch_norm * (ParameterNormalizer.PITCH_MAX - ParameterNormalizer.PITCH_MIN) + ParameterNormalizer.PITCH_MIN
    ...
    def denormalize_depth(depth_norm: np.ndarray) -> np.ndarray:
        ...
        """
        return depth_norm * (ParameterNormalizer.DEPTH_MAX - ParameterNormalizer.DEPTH_MIN) + ParameterNormalizer.DEPTH_MIN
